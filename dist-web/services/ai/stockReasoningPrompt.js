...
export function buildYTTDataBlock({ query = "", mode = "", ticker = "", assetType = "", selectedTab = "", context = {} } = {}) {
  ...
  const data = {
    ...
    aiHeatmap: compact(context.aiHeatmap || context.decisionContext?.aiHeatmap || null),
    cryptoScannerPro: compact(context.cryptoScannerPro || context.decisionContext?.cryptoScannerPro || null),
